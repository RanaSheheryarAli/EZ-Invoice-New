...
const { createProduct, getProductsBySubcategory, getProductById, updateProduct, deleteProduct, getProductsByBusiness,getProductByBarcode , searchProductsByName} = require("../controllers/productController");
